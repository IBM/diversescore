...
void SearchSpace::get_states_trace_from_path(const std::vector<OperatorID> &path, std::vector<StateID> &plan_trace, const TaskProxy &task_proxy) const {
    assert(plan_trace.empty());
