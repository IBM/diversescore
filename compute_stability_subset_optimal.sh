...
SCORE="subset_optimal(compute_stability_metric=true,aggregator_metric=min,plans_as_multisets=true,plans_subset_size=$5,metric_computation_method=mip,dump_plans=true)"
